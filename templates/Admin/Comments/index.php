    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $comment->has('question') ? $this->Html->link($comment->question->id, ['controller' => 'Questions', 'action' => 'view', $comment->question->id]) : '' ?></td>
                <td><?= $comment->has('answer') ? $this->Html->link($comment->answer->id, ['controller' => 'Answers', 'action' => 'view', $comment->answer->id]) : '' ?></td>
